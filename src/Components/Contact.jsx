    ...
    return (
        <div id='Contact' className='w-[80%] h-auto py-5 mt-6 mx-auto shadow-lg rounded-xl shadow-gray-500 flex flex-col dark:shadow-gray-900'>
            ...
            <form name='submit-to-google-sheet' className='w-full h-auto flex flex-col'>
                ...
                <textarea placeholder='Your Message' name='Message' className='border-[1px] border-gray-700 bg-slate-100 w-[85%] mt-4 min-h-60 max-h-64 py-2 mx-auto md:text-lg px-3 outline-none rounded-lg md:min-h-48 md:max-h-56 dark:border-white dark:bg-gray-300'></textarea>
