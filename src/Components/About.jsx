...
const About = () => {
    return (
        <div id='About' className='w-[80%] h-auto py-5 mt-6 mx-auto shadow-lg rounded-xl shadow-gray-500 flex flex-col'>
            <div className='mx-auto font-newFont text-gray-700 text-sm  md:text-base'>Get To Know More</div>
